  ...
  return (
    <main className="relative min-h-screen bg-[#1a0104] text-[#fff8e7] px-4 py-10 overflow-hidden flex flex-col justify-between">
      ...
      <div className="relative z-10 max-w-5xl mx-auto w-full my-auto">
        ...
        {/* Main Hero Card */}
        <div className="rounded-3xl border-2 border-amber-400/80 dark:border-amber-500/80 bg-gradient-to-b from-[#580000] via-[#430000] to-[#2d0000] p-8 sm:p-12 shadow-2xl shadow-amber-500/10 backdrop-blur-xl">
