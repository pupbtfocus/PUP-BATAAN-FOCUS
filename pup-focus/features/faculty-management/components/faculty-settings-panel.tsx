...
export function FacultySettingsPanel() {
  ...
  return (
    <div className="space-y-6">
      {/* Top Header */}
      <div className="flex items-center justify-between border-b border-slate-400 dark:border-slate-800/80 pb-4">
        <div>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
        ...
        <article className="rounded-2xl border border-slate-400/80 bg-white shadow-sm shadow-slate-200/60 dark:border-slate-800/80 dark:bg-slate-900/60 dark:shadow-none p-6 transition-colors">
          <div className="pb-4 border-b border-slate-400 dark:border-slate-800/80">
            ...
            <form onSubmit={handleSaveName} className="mt-5 space-y-5">
              ...
              <div className="flex items-center gap-4">
                <div className="relative group shrink-0">
                  <div className="h-20 w-20 rounded-full border border-slate-400 dark:border-slate-700/80 bg-slate-100 dark:bg-slate-950 overflow-hidden flex items-center justify-center text-lg font-semibold text-slate-800 dark:text-slate-200 shadow-sm">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="sm:col-span-2">
                  ...
                  <input
                    className="w-full bg-slate-100 dark:bg-slate-900/50 border border-slate-400 dark:border-slate-800 text-slate-700 dark:text-slate-400 cursor-not-allowed rounded-xl px-4 py-2.5 text-xs font-medium"
                    value={account.email}
                    disabled
                    readOnly
                  />
      ...
      {isProfileImageMenuOpen && (
        ...
        >
          <div
            className="w-full max-w-md rounded-2xl border border-slate-400 bg-white dark:border-slate-800 dark:bg-slate-900 shadow-2xl overflow-hidden"
            onClick={(event) => event.stopPropagation()}
          >
            <div className="flex items-center justify-between border-b border-slate-400 dark:border-slate-800 px-6 py-4">
              <h3
            ...
            <div className="p-6 space-y-3">
              <button
                type="button"
                className="flex w-full items-center justify-between rounded-xl border border-slate-400 bg-slate-50/80 dark:border-slate-800 dark:bg-slate-950/60 px-4 py-3.5 text-left text-slate-800 dark:text-slate-200 transition hover:border-slate-500 hover:bg-slate-100 dark:hover:border-slate-700 dark:hover:bg-slate-800/40 cursor-pointer"
                onClick={() => {
      ...
      {isFullImageOpen && (
        ...
        >
          <div
            className="w-full max-w-lg rounded-2xl border border-slate-400 bg-white dark:border-slate-800 dark:bg-slate-900 shadow-2xl overflow-hidden"
            onClick={(event) => event.stopPropagation()}
          >
            <div className="flex items-center justify-between border-b border-slate-400 dark:border-slate-800 px-6 py-4">
            ...
            <div className="p-6">
              <div className="flex items-center justify-center overflow-hidden rounded-xl border border-slate-400 dark:border-slate-800 bg-slate-100 dark:bg-slate-950 max-h-[60vh]">
                {displayedProfileImage ? (
                  <img
                    src={displayedProfileImage}
