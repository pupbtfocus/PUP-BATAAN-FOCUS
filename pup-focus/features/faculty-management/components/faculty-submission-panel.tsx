...
function FacultySubmissionPanelContent({
  ...
  return (
    <div className="relative flex min-h-full w-full items-stretch gap-0">
      ...
      <aside className="hidden md:flex md:flex-col fixed left-0 top-14 h-[calc(100vh-3.5rem)] w-56 overflow-y-auto rounded-none border-r border-l-0 border-[#000000] dark:border-slate-800 bg-[#F6F8FC] dark:bg-slate-950 p-2.5 shadow-sm transition-colors duration-200">
        <div className="my-1.5 rounded-2xl bg-slate-200 dark:bg-slate-900 border-2 border-solid border-[#000000] dark:border dark:border-slate-800 p-2.5 flex flex-col items-center shadow-sm shadow-slate-200/60 dark:shadow-none transition-colors">
          ...
          <span className="mt-0.5 inline-flex items-center justify-center px-2.5 py-0.5 text-[10px] uppercase tracking-[0.12em] font-semibold rounded-full bg-slate-200 dark:bg-slate-800 text-slate-800 dark:text-slate-200 border border-solid border-[#000000] dark:border-slate-700">
            Faculty
          </span>
        </div>
      ...
      {isMobileMenuOpen && (
        ...
        >
          <aside
            className="relative flex flex-col h-full w-64 bg-[#F6F8FC] dark:bg-slate-950 border-r border-[#000000] dark:border-slate-800 p-4 shadow-2xl transition-colors duration-200"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex items-center justify-between pb-3 border-b border-[#000000] dark:border-slate-800 mb-2">
      ...
      <div className="md:ml-56 flex min-h-full w-full md:w-[calc(100%-14rem)] flex-col">
        <div className="flex min-h-0 flex-1 flex-col overflow-hidden border-l border-[#000000] dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm transition-colors duration-200">
          <div className="min-h-0 flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors duration-200">
            {activeView === "submit" ? (
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#000000] dark:border-slate-800 pb-4 mb-6">
                <div>
            ...
            {activeView === "dashboard" && (
              <article className="space-y-6">
                {/* Top Hero Section */}
                <section className="relative overflow-hidden rounded-2xl border-2 border-solid border-[#000000] bg-slate-200 dark:border dark:border-slate-800/80 dark:bg-slate-900 p-6 sm:p-7 shadow-sm shadow-slate-200/60 dark:shadow-none transition-colors">
                  ...
                  <div className="absolute inset-0 pointer-events-none opacity-[0.06] dark:opacity-[0.14] mix-blend-luminosity overflow-hidden">
                    <Image
                      ...
                      priority
                    />
                    <div className="absolute inset-0 bg-gradient-to-r from-slate-200/90 via-slate-200/50 to-slate-200/90 dark:from-slate-950 dark:via-slate-900/60 dark:to-slate-950/90" />
                  </div>
                ...
                <section className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  ...
                  <div className="rounded-2xl border-2 border-solid border-[#000000] bg-slate-200 shadow-sm shadow-slate-200/60 dark:border dark:border-slate-800/80 dark:bg-slate-900 dark:shadow-none p-5 space-y-3 transition-colors">
                    ...
                    <div className="h-2.5 w-full overflow-hidden rounded-full bg-slate-200 dark:bg-slate-800/90 border-2 border-solid border-[#000000] dark:border dark:border-slate-700">
                      <div
                  ...
                  <div className="rounded-2xl border-2 border-solid border-[#000000] bg-slate-200 shadow-sm shadow-slate-200/60 dark:border dark:border-slate-800/80 dark:bg-slate-900 dark:shadow-none p-5 space-y-3 transition-colors">
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        className={`inline-flex items-center gap-1 text-[11px] font-semibold px-2 py-0.5 rounded-full border border-solid border-[#000000] dark:border-blue-500/20 ${
                          hasActiveSchedule && !isWindowClosed
                            ? "text-blue-900 bg-blue-100 dark:text-blue-400 dark:bg-blue-500/10"
                            : "text-amber-900 bg-amber-100 dark:text-amber-400 dark:bg-amber-500/10"
                        }`}
                      >
                ...
                <section className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
                  ...
                  <div className="lg:col-span-2 space-y-4">
                    <div className="rounded-2xl border-2 border-solid border-[#000000] bg-slate-200 shadow-sm shadow-slate-200/60 dark:border dark:border-slate-800/80 dark:bg-slate-900 dark:shadow-none p-5 sm:p-6 transition-colors">
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-4 border-b border-[#000000] dark:border-slate-800/80">
                        <div>
                      ...
                      {isLoadingStatuses ? (
                        ...
                        <div className="mt-4">
                          {displayedRequirementStatuses.filter(
                            ...
                            <div className="rounded-xl border-2 border-emerald-600/40 bg-emerald-500/5 p-6 text-center space-y-2">
                              ...
                              <button
                                type="button"
                                onClick={() => navigateToView("status")}
                                className="mt-2 inline-flex items-center gap-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 dark:bg-slate-900 dark:hover:bg-slate-800 dark:text-slate-300 dark:hover:text-slate-100 border border-solid border-[#000000] dark:border-slate-800 rounded-lg px-3 py-1.5 text-xs font-medium transition cursor-pointer"
                              >
                                View Requirements Table
                              </button>
                            </div>
                          ) : (
                            <div className="bg-white dark:bg-slate-950/60 border-2 border-solid border-[#000000] dark:border dark:border-slate-800/80 rounded-2xl divide-y divide-[#000000] dark:divide-slate-800/60 overflow-hidden shadow-xs">
                              {displayedRequirementStatuses
                                .filter((req) => req.status === "Not Submitted" || req.status === "Rejected")
                                .map((req) => (
                                  <div
                                    key={req.code}
                                    className="p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white dark:bg-slate-950/60 hover:bg-slate-100/80 dark:hover:bg-slate-800/20 transition-colors"
                                  >
                  ...
                  <div className="space-y-6">
                    {/* Activity Feed Card */}
                    <div className="rounded-2xl border-2 border-solid border-[#000000] bg-slate-200 shadow-sm shadow-slate-200/60 dark:border dark:border-slate-800/80 dark:bg-slate-900 dark:shadow-none p-5 space-y-4 transition-colors">
                      <div className="flex items-center justify-between pb-3 border-b border-[#000000] dark:border-slate-800/80">
                      ...
                      {deduplicatedRecentActivities.length > 0 ? (
                        <div className="space-y-3">
                          {deduplicatedRecentActivities.map((sub) => (
                            <div
                              key={sub.id}
                              className="flex items-start gap-3 p-2.5 rounded-xl bg-white dark:bg-slate-950/60 border-2 border-solid border-[#000000] dark:border dark:border-slate-800/60 transition-colors"
                            >
            ...
            {activeView === "status" && (
              <article className="space-y-5 p-2 sm:p-4 md:p-5">
                {/* Minimalist Header */}
                <div className="flex flex-wrap items-center justify-between gap-3 border-b border-[#000000] dark:border-slate-800/80 pb-4">
                  <div>
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <button
                      type="button"
                      onClick={openHistoryModal}
                      className="inline-flex items-center gap-1.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 border border-solid border-[#000000] dark:border-slate-700 rounded-xl px-3.5 py-1.5 text-xs font-semibold transition-colors cursor-pointer whitespace-nowrap"
                    >
                ...
                {(!hasActiveSchedule || isWindowClosed) && (
                  <div className="p-3 sm:p-3.5 rounded-xl border-2 border-amber-600/50 bg-amber-50 dark:bg-amber-500/10 text-xs text-amber-950 dark:text-amber-200">
                ...
                {isLoadingStatuses ? (
                  ...
                  <div className="bg-slate-200 border-2 border-solid border-[#000000] shadow-sm shadow-slate-200/60 dark:bg-slate-900 dark:border dark:border-slate-800/80 dark:shadow-none rounded-2xl divide-y divide-[#000000] dark:divide-slate-800/60 overflow-hidden transition-colors">
                    {displayedRequirementStatuses.map((req) => (
                      <div
                        key={req.code}
                        id={`requirement-${req.code}`}
                        className="px-5 py-3.5 flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white dark:bg-slate-950/60 hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors"
                      >
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-1.5">
                            ...
                            {req.status !== "Not Submitted" && req.latestSubmissionId ? (
                              <>
                                ...
                                className="relative inline-flex items-center gap-1.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 border border-solid border-[#000000] dark:border-slate-700 rounded-xl px-3.5 py-1.5 text-xs font-semibold transition-colors cursor-pointer"
                              >
                                  {Boolean(
                                    req.feedback &&
                                ...
                                className="inline-flex items-center gap-1.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 border border-solid border-[#000000] dark:border-slate-700 rounded-xl px-3.5 py-1.5 text-xs font-semibold transition-colors cursor-pointer"
                              >
                                  <History className="h-3.5 w-3.5" />
                                  History
                                </button>
                ...
                >
                  <div className="flex items-center justify-between border-b border-[#000000] dark:border-slate-800 px-6 py-5">
                    ...
                    <button
                      ...
                      className="rounded-full border border-solid border-[#000000] dark:border-slate-700 p-2 text-slate-500 hover:text-slate-900 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-slate-100 disabled:opacity-50"
                  ...
                  <form onSubmit={handleDirectUploadSubmit} className="p-6 space-y-5">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={3}
                        className="w-full rounded-xl border border-solid border-[#000000] dark:border-slate-700 bg-white dark:bg-slate-950 p-3 text-sm text-slate-900 dark:text-slate-100 outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 transition"
                    ...
                    <div className="flex items-center justify-end gap-3 pt-3 border-t border-[#000000] dark:border-slate-800">
                      <button
                        type="button"
                        onClick={closeDirectUploadModal}
                        disabled={isUploadingDirect}
                        className="rounded-xl border border-solid border-[#000000] dark:border-slate-700 px-4 py-2 text-sm text-slate-700 dark:text-slate-300 transition hover:bg-slate-100 dark:hover:bg-slate-800 disabled:opacity-50 font-medium"
                      >
                        Cancel
                      </button>
                      <Button
            ...
            {isMounted && isSubmittingModalOpen && (
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4 animate-in fade-in">
                <div className="bg-gradient-to-b from-[#3a0000] to-[#1a0000] border-2 border-solid border-[#000000] dark:border dark:border-amber-500/30 rounded-3xl p-8 max-w-sm w-full text-center shadow-2xl space-y-4">
                  {isUploadingDirect ? (
                    <>
            ...
            {isMounted && successModalData.isOpen && (
              ...
              >
                <div
                  className="w-full max-w-md rounded-3xl border-2 border-solid border-[#000000] dark:border dark:border-slate-700 bg-slate-200 dark:bg-slate-900 p-6 text-center shadow-2xl overflow-hidden"
                  onClick={(e) => e.stopPropagation()}
                >
            ...
            {isMounted && isHistoryModalOpen && (
              ...
              >
                <div
                  className="flex max-h-[85vh] w-full max-w-4xl flex-col rounded-3xl border-2 border-solid border-[#000000] dark:border dark:border-slate-700 bg-slate-200 dark:bg-slate-900 shadow-2xl"
                  onClick={(event) => event.stopPropagation()}
                >
                  <div className="flex items-center justify-between border-b border-[#000000] dark:border-slate-800 px-6 py-5">
                    <h3
                    ...
                    <button
                      type="button"
                      onClick={closeHistoryModal}
                      className="rounded-full border border-solid border-[#000000] dark:border-slate-700 p-2 text-slate-500 hover:text-slate-900 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-slate-100"
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-3 border-b border-[#000000] dark:border-slate-800 bg-slate-50 dark:bg-slate-950/60 px-6 py-3">
                    <div className="flex flex-wrap items-center gap-4">
                      <div className="flex items-center gap-2">
                        ...
                        <select
                          ...
                          className="rounded-xl border border-solid border-[#000000] dark:border-slate-700 bg-white dark:bg-slate-950 px-3 py-1.5 text-xs text-slate-900 dark:text-slate-200 outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500"
                  ...
                  <div className="flex justify-end border-t border-[#000000] dark:border-slate-800 px-6 py-4">
                    <Button
                      type="button"
                      variant="secondary"
                      onClick={closeHistoryModal}
            ...
            {isMounted && previewSubmission ? (
              ...
              >
                <div
                  className="w-full max-w-4xl rounded-3xl border-2 border-solid border-[#000000] dark:border dark:border-slate-700 bg-slate-200 dark:bg-slate-900 shadow-2xl overflow-hidden"
                  onClick={(event) => event.stopPropagation()}
                >
                  <div className="flex items-start justify-between border-b border-[#000000] dark:border-slate-800 px-6 py-5">
                  ...
                  <div className="grid gap-6 px-6 py-6 lg:grid-cols-[minmax(0,1.35fr)_minmax(280px,0.65fr)]">
                    <div className="min-h-[60vh] overflow-hidden rounded-2xl border-2 border-solid border-[#000000] dark:border-slate-700 bg-slate-100 dark:bg-slate-950">
                      <iframe
                    ...
                    <div className="space-y-4">
                      <div className="rounded-2xl border border-solid border-[#000000] dark:border-slate-700 bg-white dark:bg-slate-950/60 p-4">
                      ...
                      {previewSubmission.submittedAt ? (
                        <div className="rounded-2xl border border-solid border-[#000000] dark:border-slate-700 bg-white dark:bg-slate-950/60 p-4 text-sm text-slate-700 dark:text-slate-300">
                          <p className="text-xs uppercase tracking-[0.18em] text-slate-600 dark:text-slate-400 font-semibold">
                            Submitted On
                          </p>
            ...
            {isMounted && showIncompleteRequirementsModal ? (
              ...
              >
                <div className="w-full max-w-md rounded-2xl border-2 border-solid border-[#000000] dark:border dark:border-slate-800 bg-slate-200 dark:bg-slate-900 p-6 shadow-xl relative animate-in fade-in zoom-in-95 duration-200">
                  ...
                  <div className="bg-white dark:bg-slate-950/60 border-2 border-solid border-[#000000] dark:border dark:border-slate-800/80 rounded-xl p-4 my-4 flex items-center justify-between text-xs text-slate-700 dark:text-slate-300">
            ...
            {isMounted && isSubmitModalOpen && (
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 px-4 py-6 backdrop-blur-sm">
                <div className="w-full max-w-3xl overflow-hidden rounded-3xl border-2 border-solid border-[#000000] dark:border dark:border-slate-700 bg-slate-200 dark:bg-slate-900 shadow-2xl">
                  <div className="flex items-start justify-between border-b border-[#000000] dark:border-slate-700 px-6 py-5">
                  ...
                  <div className="max-h-[75vh] overflow-y-auto p-6">
                    {isSubmissionAvailable ? (
                      <form className="space-y-4" onSubmit={handleSubmit}>
                        <div className="grid gap-4 md:grid-cols-2">
                          <div className="grid gap-4 md:grid-cols-2">
                            <div>
                              ...
                              <p className="mt-2 rounded-xl border border-solid border-[#000000] dark:border-slate-700 bg-slate-50 dark:bg-slate-950 px-3 py-3 text-sm text-slate-800 dark:text-slate-100 font-medium">
                                {form.academicYear
                                  ? `S.Y. ${form.academicYear}`
                                  : "Loading current term..."}
                              </p>
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className="mt-1 w-full rounded-xl border border-solid border-[#000000] dark:border-slate-700 bg-white dark:bg-slate-950 px-3 py-2 text-sm text-slate-900 dark:text-slate-100 outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500"
                            value={form.requirementCode}
                            onChange={(event) =>
                              updateField(
                                "requirementCode",
                        ...
                        <div>
                          ...
                          <input
                            ...
                            id="modalFileName"
                            type="file"
                            className="mt-1 w-full rounded-xl border border-solid border-[#000000] dark:border-slate-700 bg-white dark:bg-slate-950 px-3 py-2 text-sm text-slate-700 dark:text-slate-300 outline-none file:mr-4 file:rounded-lg file:border-0 file:bg-amber-500 file:px-4 file:py-2 file:text-sm file:font-semibold file:text-slate-950 hover:file:bg-amber-400 disabled:opacity-50"
                        ...
                        <div>
                          ...
                          <textarea
                            id="modalRemarks"
                            className="mt-1 min-h-24 w-full rounded-xl border border-solid border-[#000000] dark:border-slate-700 bg-white dark:bg-slate-950 px-3 py-2 text-sm text-slate-900 dark:text-slate-100 outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500"
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <button
                            type="button"
                            onClick={closeSubmitModal}
                            className="rounded-xl border border-solid border-[#000000] dark:border-slate-700 px-4 py-2 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 font-medium"
                          >
                            Cancel
                          </button>
                        </div>
                      ...
                      <div className="rounded-xl border border-solid border-[#000000] dark:border-slate-700 bg-slate-950 p-4 text-sm text-slate-300">
                        {isLoadingSubmissionWindow
