...
import { X, Pencil, CheckCircle2, Clock3, AlertCircle, Calendar, Building, Mail, User, ShieldCheck } from "lucide-react";
...
export function FacultyDetailsModal({
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-2xl max-h-[92vh] overflow-y-auto rounded-2xl border border-slate-300 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100">
        {/* Header */}
        ...
        <div className="space-y-6 p-6">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/60 p-4.5">
            <div className="flex h-16 w-16 shrink-0 items-center justify-center overflow-hidden rounded-full border border-slate-300 dark:border-slate-700 bg-slate-200 dark:bg-slate-800 text-xl font-bold text-slate-700 dark:text-slate-200">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950/40 p-4 space-y-3">
              ...
              <div className="space-y-2 text-xs divide-y divide-slate-100 dark:divide-slate-800/60">
                ...
                <div className="flex justify-between py-1.5">
                  <span className="text-slate-500 dark:text-slate-400">Last Login Date & Time</span>
                  <span className="font-semibold text-slate-800 dark:text-slate-200">
                    {formattedLastLogin}
                  </span>
                </div>
            ...
            <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950/40 p-4 space-y-3">
              ...
              <div className="space-y-2 text-xs divide-y divide-slate-100 dark:divide-slate-800/60">
                ...
                <div className="flex justify-between py-1.5">
                  ...
                  <span className="font-semibold text-slate-800 dark:text-slate-200 text-right max-w-[180px] truncate" title={programFullName}>
                    {programFullName}
                  </span>
                </div>
                <div className="flex justify-between py-1.5">
            ...
            <div className="grid gap-2 sm:grid-cols-2">
              {DEFAULT_REQUIREMENTS.map((code) => {
                ...
                return (
                  ...
                  >
                    <span className="font-medium text-slate-700 dark:text-slate-300 truncate" title={label}>
                      {label}
                    </span>
        ...
        {/* Modal Footer */}
        <div className="sticky bottom-0 flex items-center justify-between border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-6 py-3.5">
