      ...
      {showModal && (
        <div className="fixed inset-0 z-50 bg-slate-950/60 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-200">
          <div className="max-w-md w-full bg-white dark:bg-slate-900 border border-slate-400/80 dark:border-slate-800 rounded-xl shadow-2xl p-6 text-slate-900 dark:text-slate-100">
            ...
            <div className="my-5 rounded-lg border border-slate-400/80 dark:border-slate-800/80 bg-slate-50 dark:bg-slate-950/50 p-4 text-center">
            ...
            <div className="flex items-center gap-3 pt-1">
              ...
              <button
                ...
                className="border border-slate-400 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 font-semibold px-4 py-2.5 rounded-lg transition-colors text-xs cursor-pointer inline-flex items-center justify-center gap-1.5"
              >
                <AppIcon icon={LogOut} size="sm" color="inherit" />
                <span>Sign Out</span>
              </button>
            </div>
          </div>
